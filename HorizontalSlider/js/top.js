(function($) {
  ...
  (function() {
    ...
    $videoTVCM.on('ended', function() {
      $(this)
        .siblings('.js-tvcm-button')
        .removeClass('hide');
    });
    $videoTVCM.on('pause', function() {
      $(this)
        .siblings('.js-tvcm-button')
        .removeClass('hide');
    });
